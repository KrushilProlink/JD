    ...
    <>
      {!isOpen ? (
                        ...
                        ?.map((item, index) => (
                          <tr>
                            ...
                            <td className="text-gray-900 fw-bold text-hover-primary fs-6 text-center">
                              ...
                              >
                                <source
                                  src={item?.audio_player}
                                  type="audio/mpeg"
                                />
                                {/* <source
                          src={
                            "https://asterisk-xlite-recording.s3.ap-south-1.amazonaws.com/external-1088-09826229899-20240520-162820-1716202700.166039.wav"
                          }
                          type="audio/wav"
                        /> */}
                              </audio>
                            ...
                            <td className="text-gray-900 fw-bold text-hover-primary pe-4">
                              <span
                                ...
                                style={{ float: "right" }}
                                onClick={() =>
                                  handleDownload(item?.candidate_cell_no)
                                }
                              >
        ...
        <div className="card-body">
          <Report data={reportData} close={() => setIsOpen(false)} />
        </div>
      )}
    </>
  );
